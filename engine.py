...
def train_step(
  ...
  Returns:
    A tuple of training loss, training accuracy metrics and latest learning rate, in the form (train_loss, train_accuracy, learning_rate).
  ...
  return avg_loss, avg_acc, learning_rate
